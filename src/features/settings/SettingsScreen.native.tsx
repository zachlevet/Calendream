...
export function SettingsScreen({ colors, onDataChanged }: SettingsScreenProps) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={[styles.card, { backgroundColor: colors.card }]}>
        <SettingsRow colors={colors} detail="Revisit the Today, Timeline, and Plan walkthrough. Your current data stays untouched." disabled={busy !== null} icon="sparkles" onPress={() => setTourOpen(true)} title="View welcome tour" />
      </View>
